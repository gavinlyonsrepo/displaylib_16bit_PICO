/*!
	...
	@note   See USER OPTIONS 0-2 in SETUP function
			This example is for 50x160 single gate.
			This example requires macro GC9D01_SINGLE_INIT_50x160,
			...
			Requires usable heap memory of (50x160x2) = 16,000 bytes for buffer
	@test
		-# Test 102 Print out Hello world on single gate 50x160
*/
