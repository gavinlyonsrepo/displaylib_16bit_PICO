...
This mode was added in Version 2.1.0. and is non-default.
...
There are examples for Advanced buffer mode. These are called "frame_buffer". ALL examples for GC9D01 are for advanced buffer mode.
